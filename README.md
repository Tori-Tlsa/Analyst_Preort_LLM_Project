...
1. **API 비용**: Gemini API 사용료 발생
   - 무료 크레딧: 월 2백만 토큰
   - 초과: 1백만 토큰당 약 $0.075

2. **네트워크**: PDF 다운로드에 시간 소요 (30분~)

3. **시스템**: RAM 8GB+, 저장공간 2GB+ 권장
...
### v2.0.0 (2026-03-03)
  - ✅ Bullish Outlook 제거 → Confidence만 유지
  - ✅ Firm-Quarter 집계로 LLM_avg, LLM_std 생성
  - ✅ Robust Error Handling (Rate Limit, Retry, 유효성 검사)
  - ✅ Ablation Study로 모델 성능 개선도 정량화
  - ✅ 전문 기술 문서로 README 개선

### v1.0.0 (2026-03-01)
- 단계 1-5 기본 파이프라인 완성
- Confidence + Bullish Outlook 이중 점수 시스템
